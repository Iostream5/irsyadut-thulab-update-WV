      ...
      <div class="scroll-content">
        <div class="sidebar-list">
          ...
          <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/alquran.html">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/hadits.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/sunnah.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/maulid.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/doa.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/sholawat.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="../dashboard/praktek.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dashboard/jadwal_solat.html">
                <i class="icon">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../dashboard/tentang.html">
                <i class="icon">
